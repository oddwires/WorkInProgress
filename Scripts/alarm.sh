...
#     Latest details and build instructions... https://github.com/oddwires/alarm-system                                         #
#     Latest code and issues...                https://github.com/oddwires/alarm-system                                         #
#                                                                                                                               #
#################################################################################################################################
#                                                                                                                               #
# Features:                                                                                                                     #
...
{  ConfigDotJsonPath="/var/lib/homebridge/"
   ...
   while [ $i -le "$maxval" ]; do
        ...
        StatusStr=$AccName".*On:On\\\|"$AccName".*On:Off\\\|"$AccName".*On:None' /var/www/data/status.txt"
...
#################################################################################################################################
{
  ...
  pinctrl set 4 op pn
  pinctrl set 17 op pn
  pinctrl set 18 op pn
  pinctrl set 23 op pn
  pinctrl set 11 op pn
  pinctrl set 8 op pn
  pinctrl set 7 op pn
